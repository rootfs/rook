...
func NewClusterController(context *clusterd.Context, rookImage, cephImage string, volumeAttachment attachment.Attachment) *ClusterController {
...
func (c *ClusterController) onAdd(obj interface{}) {
	...
	err := wait.Poll(clusterCreateInterval, clusterCreateTimeout, func() (bool, error) {
		...
		err := cluster.createInstance(c.rookImage, c.cephImage)
		if err != nil {
...
func (c *ClusterController) handleUpdate(newClust *rookalpha.Cluster, cluster *cluster) (bool, error) {
	...
	if err := cluster.createInstance(c.rookImage, c.cephImage); err != nil {
